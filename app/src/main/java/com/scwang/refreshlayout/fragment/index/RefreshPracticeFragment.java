...
import com.scwang.refreshlayout.fragment.practice.TwoLevelPracticeFragment;
...
public class RefreshPracticeFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private enum Item {
        ...
        TwoLevel(R.string.index_practice_second_floor, TwoLevelPracticeFragment.class),
        ;
        @StringRes
        public int name;
        public Class<?> clazz;
